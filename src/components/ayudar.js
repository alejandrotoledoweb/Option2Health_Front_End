...
import { getUserStudyCases, createStudyCase } from '../redux/actions/studyCasesActions';
...
const Ayudar = ({logged_in, user, getUserStudyCases, allStudyCases, updateStudyCase, createStudyCase, medico, empresa}) => {
      ...
      <section className="inline-block absolute mx-6 justify-center">
        ...
        <div className="grid gridcols-1 lg:grid-cols-2 gap-4 my-2 py-2 bg-white rounded text-center self-center">
          ...
          <div  className="border rounded my-2 py-4">
            <p className="text-indigo-600 my-2 text-xl font-bold w-full self-center">Ayudanos a Ayudar</p>
            <p className="text-black my-2 text-md w-full self-center py-2 px-2">Hay millones de personas con enfermedades sin diagnósitco. Se parte de nuestra red de crowdsourcing conformada por especialistas médicos de todo el mundo, y ayudanos a analizar exámenes, sugerir diagnósticos y recomendar tratamiento de difícil resolución.</p>
            <button onClick={() => handleShow()}>

              <p className="text-indigo-600 my-2 text-md font-bold w-full self-center">Para compartir un CASO y que otro médicos te ayuden has CLICK AQUÍ</p>
            </button>
          ...
          <div className="border rounded my-2 py-4">
            ...
            <p className="text-indigo-600 my-2 text-xl font-bold w-full self-center">Número de casos de estudio</p>
          </div>
        </div> 
        ...
        <section className="my-2 px-2 flex-wrap items-center justify-center grid grid-cols-1 md:grid-cols-2 gap-6">
          {allStudyCases ? allStudyCases.map((sc) => (

            <article key={sc?.study_case?.id} className="my-10 relative shadow p-4 mb-5 bg-white rounded mx-auto border w-full">
              ...
              <h6 className="text-left font-bold mt-3 mr-20">{sc?.study_case?.nombre}</h6>
              {/* <p className="text-left font-semibold mb-2">Síntomas Uterinos</p> */}
              <hr className="text-black"></hr>
              <div className="flex items-center content-center flex-col">
                <p className="my-3 mr-16 pr-2">{sc?.study_case?.descripcion}<a href="https://medlineplus.gov/spanish/ency/article/000914.htm" target="_blank" rel="noreferrer" className="text-indigo-400">Ver más...</a></p>
                <div className="aspect-w-16 aspect-h-9 max-w-full w-full">
                  <iframe  src={sc?.study_case?.video} title="YouTube video player" frameborder="0" allowfullscreen></iframe>
                </div>
                <div>
                  <p className="my-2 font-bold text-center text-lg">Comentarios recientes:</p>
                  {sc?.comments?.map(com => (
        ...
        <section className="">
          <Modal show={showForm} animation={true} onHide={handleClose} dialogClassName="modal-90w" aria-labelledby="example-modal-sizes-title-lg">
            <Modal.Header>
              <Modal.Title id="example-modal-sizes-title-lg">Formulario para crear un Caso de Estudio</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                  ...
                  <div className="">
                      <Form>
                        ...
                        <section className="block mx-4 pt-4 rounded ">
                          ...
                          <div className=' '>
                                <FormikControl control='textarea' label='Texto de descripción del caso de estudio(*)' name='descripcion' id='descripcion' className='bg-gray-200'/>
                                <ErrorMessage
                                  name="descripcion"
                                  component="span"
                          ...
                          <div className=' '>
                                <FormikControl control='textarea' label='Exámenes realizados(*)' name='examenes' id='examenes' className='bg-gray-200'/>
                                <ErrorMessage
                                  name="examenes"
                                  component="span"
                                  className="text-red-600 mt-2 mb-4 flex justify-center"
                          ...
                          <div className=' '>
                                <FormikControl control='textarea' label='Tratamiento usado:(*)' name='tratamiento' id='tratamiento' className='bg-gray-200'/>
                                <ErrorMessage
                                  name="tratamiento"
                                  component="span"
                                  className="text-red-600 mt-2 mb-4 flex justify-center"
                          ...
                          <div className=''>
                                <FormikControl control='textarea' label='Médicos visitados anteriormente:(*)' name='medicos' id='medicos' className='bg-gray-200'/>
                                <ErrorMessage
                                  name="medicos"
                                  component="span"
                                  className="text-red-600 mt-2 mb-4 flex justify-center"
