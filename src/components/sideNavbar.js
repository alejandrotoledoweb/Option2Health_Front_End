    ...
    <nav className="h-full">
          <ul className="">
            ...
            <li className="text-indigo-500 py-2 my-2 mx-2">
              {medico && logged_in? <Link to="/nuevapublicacion" className='mx-2 text-indigo-500 flex justify-items-start'><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>Agregar Publicación</Link> : ""}
            </li>
            <li className="text-indigo-500 py-2 my-2 mx-2">
              {medico && logged_in? <Link to="/ayudar" className='mx-2 text-indigo-500 flex justify-items-start'><i class="fas fa-hands-helping"></i> &nbsp;Ayudanos a Ayudar</Link> : ""}
            </li>
          </ul>
        </nav>
  )
